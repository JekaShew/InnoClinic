...
public class DoctorSpecializationCreatedEventValidator : AbstractValidator<DoctorSpecializationCreatedEvent>
{
    public DoctorSpecializationCreatedEventValidator()
    {
        RuleFor(ds => ds)
           .NotNull()
