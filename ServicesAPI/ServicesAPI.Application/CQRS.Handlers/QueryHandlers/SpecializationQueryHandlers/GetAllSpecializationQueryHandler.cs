...
public class GetAllSpecializationQueryHandler : IRequestHandler<GetAllSpecializationsQuery, ResponseMessage<IEnumerable<SpecializationTableInfoDTO>>>
{
    private readonly IRepositoryManager _repositoryManager;
    private readonly IMapper _mapper;

    public GetAllSpecializationQueryHandler(IRepositoryManager repositoryManager, IMapper mapper)
    {
